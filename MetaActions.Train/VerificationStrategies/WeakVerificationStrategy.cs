...
{
    public class WeakVerificationStrategy : BaseVarificationStrategy
    {
        public int TimeLimit { get; set; }
        public WeakVerificationStrategy(string name, int runID, string tempPath, CancellationTokenSource token, int timeLimit) : base(name, runID, tempPath, token)
        {
            TimeLimit = timeLimit;
        }
