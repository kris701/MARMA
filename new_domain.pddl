...
(:action attack_move
:parameters ( ?from ?to)
:precondition (and (leader-state-room ?from)
 (leader-state-room ?to)
 (leader-state-at-robby ?from)
)
:effect (and (leader-state-at-robby ?to)
 (not (leader-state-at-robby ?from))
)
)
...
:precondition (and (leader-state-ball ?obj)
...
:effect (and (leader-state-carry ?obj ?gripper)
 (not (leader-state-at ?obj ?room))
 (not (leader-state-free ?gripper))
)
)
...
:effect (and (leader-state-at ?obj ?room)
 (leader-state-free ?gripper)
 (not (leader-state-carry ?obj ?gripper))
)
)
